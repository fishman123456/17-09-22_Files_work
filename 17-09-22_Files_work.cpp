// 17-09-22_Files_work.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
...
void Game(char* word)
{
	...
	do {
		...
		if (pos == 0)
		{
			cout << "This letter have been alreadypressed" << endl;
				Sleep(1000);
			continue;
		}
		else
